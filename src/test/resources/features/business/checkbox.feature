...
#
#    Examples:
#     | parent           | initial_state  | context                             | action           |  final_state    |
##     | homeCheckbox     | not selected   | none of them are selected           | a single child   |  indeterminate  |
##     | desktopCheckbox  | not selected   | none of them are selected           | all children     |  selected       |
##     | officeCheckbox   | indeterminate  | all of them are selected except one | the last child   |  selected       |
#
##  @son-parent
